              ...
              <div className='watchPoster'>
                ...
                <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-around" }}>
                  ...
                  <div className='watchedinfo' style={{ gap: "20px" }}>
                    <span>imdb<img src={star} alt="" />{watch.imdbRating}</span>
                    <span>my<img src={star} alt="" />{watch.movieRated}</span>
                    <span><img src={Timer} alt="" />{watch.Runtime}</span>
                  </div>
                </div>
              </div>
              <button onClick={() => cutmovie(watch.imdbID, index =index)} className='cross'>
                <RxCross2 />
              </button>
            </div>
          ))}
        ...
        <div className='ratingStar'>
          <div className='stars'>
            ...
            {[...Array(10)].map((star, index) => {
              ...
              console.log("currentRating=>",currentRating); //10
              return (
                <label>
